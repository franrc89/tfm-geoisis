...
public class Alojamientos {
	...
	@Action(semantics = SemanticsOf.SAFE)
	@MemberOrder(sequence = "1")
	@ActionLayout(named = "Buscar Alojamientos")
	public List<Alojamiento> find(
		...
		final Query q = pm.newQuery(Alojamiento.class);
		...
		final List<Alojamiento> results = (List<Alojamiento>) q.execute();
