...
@ObjectType("PUNTOINTERES_RUTAPERSONAL")
@Bookmarkable
public class PuntoInteres_RutaPersonal implements Comparable<PuntoInteres_RutaPersonal> {
	...
	@Override
	public int compareTo(final PuntoInteres_RutaPersonal o) {
