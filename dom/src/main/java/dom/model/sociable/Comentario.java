...
@DomainObject(bounded = true, objectType = "Comentario")
@DomainObjectLayout
public class Comentario implements Comparable<Comentario> {
	...
	/**
	 * Devuelve el valor de la propiedad 'texto'
	 * 
	 * @return Propiedad texto
	 */
	@Title(sequence = "2")
	...
	/**
	 * Asigna el valor de la propiedad 'texto'
	 * 
	 * @param texto
	 *            valor que se le quiere dar a la propiedad 'texto'
	 */
	 ...
	 */
	@Override
	public int compareTo(final Comentario o) {
