...
@DomainObject(bounded = true, objectType = "RutaPersonalRealizada")
@DomainObjectLayout
public class RutaPersonalRealizada implements Comparable<RutaPersonalRealizada> {
	 ...
	 * 
	 * @param rutaPersonal
	 *            valor que se le quiere dar a la propiedad 'rutaPersonal'
	 */
	 ...
	 */
	@Override
	public int compareTo(final RutaPersonalRealizada o) {
